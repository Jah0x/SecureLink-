...
- `NEXT_PUBLIC_API_BASE_URL` – базовый URL API, используется фронтендом (по умолчанию пусто)
- `NEXT_PUBLIC_HANKO_API_URL` – публичный URL сервиса Hanko для фронтенда
